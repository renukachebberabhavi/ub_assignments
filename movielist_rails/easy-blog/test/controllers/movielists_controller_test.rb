...
class MovielistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movielist" do
    assert_difference("Movielist.count") do
      post movielists_url, params: { movielist: { description: @movielist.description, director: @movielist.director, languagestring: @movielist.languagestring, name: @movielist.name } }
    end
  ...
  test "should update movielist" do
    patch movielist_url(@movielist), params: { movielist: { description: @movielist.description, director: @movielist.director, languagestring: @movielist.languagestring, name: @movielist.name } }
